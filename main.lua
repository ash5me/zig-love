...
function love.load()
    ...
    local Combat = require("streets_of_rage.combat")
    local PlayerFSM = require("streets_of_rage.player_fsm")
    local EnemyAI = require("streets_of_rage.enemy_ai")
    local GrabSystem = require("streets_of_rage.grab_system")
    local CameraManager = require("streets_of_rage.camera_manager")
